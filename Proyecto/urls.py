...
from .views import venta_eliminar_API,venta_Cancelar_API,venta_DONE,venta_dias,venta_Info,retiro_api,productovmes_api,productovsem_api,productocmes_api,productocsem_api,api_notificaciones,retiro_apiR
...
urlpatterns = [
    ...
    path('retiro/API/<int:retiro>/<int:final>',retiro_api),
    path('retiro/APIR/<int:final>',retiro_apiR),
