function Estadisticas(seleccion){
    switch(seleccion){
        case "VM":
            ...
            <li class="page-item"><a class="page-link" href="#" onclick="Estadisticas('HT')">Usuarios con mas horas trabajadas</a></li>`;
        ...
        case "CS":
            ...
            <li class="page-item"><a class="page-link" href="#" onclick="Estadisticas('VS')">Ventas Semana</a></li>
            <li class="page-item"><a class="page-link" href="#" onclick="Estadisticas('CM')">Compras mes</a></li>
            <li class="page-item active"><a class="page-link" href="#" onclick="Estadisticas('CS')">Compras Semana</a></li>
            <li class="page-item"><a class="page-link" href="#" onclick="Estadisticas('HT')">Usuarios con mas horas trabajadas</a></li>`;
            CompraSem();
            break;
        case "HT":
            ...
            <li class="page-item"><a class="page-link" href="#" onclick="Estadisticas('CM')">Compras mes</a></li>
            <li class="page-item"><a class="page-link" href="#" onclick="Estadisticas('CS')">Compras Semana</a></li>
            <li class="page-item active"><a class="page-link" href="#" onclick="Estadisticas('HT')">Usuarios con mas horas trabajadas</a></li>`;
            usuariosemanatra();
            break;
...
function usuariosemanatra(){
    mes=document.getElementById("fecha").value;
    if (!mes){
        var url1='/trabajadorsem_API/0';
    }else{
        var url1='/trabajadorsem_API/'+mes;
    }
    fetch(url1)
    .then(data=>data.json())
    .then(data=>{
